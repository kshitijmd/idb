...
kubectl set image deployment/$CLOUDSDK_DEPLOYMENT_LABEL $CLOUDSDK_DEPLOYMENT_LABEL=gcr.io/$CLOUDSDK_CORE_PROJECT/playlistr-front-app:$TRAVIS_COMMIT
# kubectl rolling-update $CLOUDSDK_DEPLOYMENT_LABEL --image=gcr.io/$CLOUDSDK_CORE_PROJECT/playlistr-front-app:$TRAVIS_COMMIT --image-pull-policy Always
