...
const slideData = [
	{
		src:
			"https://i.genius.com/bd2d786ffa10ff5c354505247dde607bd70f5924?url=http%3A%2F%2Fwww.portugaltheman.com%2Fsites%2Fg%2Ffiles%2Fg2000000591%2Ff%2F201305%2FPortugal.%2520The%2520Man%2520-%2520In%2520the%2520Mountain%2520in%2520the%2520Cloud%2520%282011%29.jpg",
...
const slides = slideData.map(item => {
	return (
		<div key={item.key}>
			<img src={item.src} style={{ width: 700 + "px", height: 700 + "px" }} />
